...
import com.example.androidproject.ui.home.ContactAdapter
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        profileViewModel.contact.observe(viewLifecycleOwner) {
            binding.textInitials.text = "${it.firstName.first()}${it.lastName.first()}"
